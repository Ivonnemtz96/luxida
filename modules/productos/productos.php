...
<main class="main-content">
    <?php 
  include("descPiedraL.php");
?>

    <!--== Start Service Area Wrapper ==-->
    <section class="service-area service-grid-area" style="margin-top: 5rem;">
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-4 col-lg-4">
                    ...
                    <div class="service-item">
                        <div class="thumb">
                            <div class="fotorama" data-autoplay="true" data-allowfullscreen="true" data-width="600"
                                data-height="400">
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    ...
                    <div class="service-item">
                        <div class="thumb">
                            <div class="fotorama" data-autoplay="true" data-allowfullscreen="true" data-width="600"
                                data-height="400">
                                <img src="/assets/img/productos/laja/laja_blanca.jpg" alt="Image">
                                <img src="/assets/img/productos/laja/laja_blanca.jpg" alt="Image">
                                <img src="/assets/img/productos/laja/laja_blanca.jpg" alt="Image">
                                <img src="/assets/img/productos/laja/laja_blanca.jpg" alt="Image">
                                <img src="/assets/img/productos/laja/laja_blanca.jpg" alt="Image">
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    ...
                    <div class="service-item">
                        <div class="thumb">
                            <div class="fotorama" data-autoplay="true" data-allowfullscreen="true" data-width="600"
                                data-height="400">
                                <img src="/assets/img/productos/laja/lajaOcre.jpg" alt="Image">
                                <img src="/assets/img/productos/laja/lajaOcre.jpg" alt="Image">
                                <img src="/assets/img/productos/laja/lajaOcre.jpg" alt="Image">
                                <img src="/assets/img/productos/laja/lajaOcre.jpg" alt="Image">
                                <img src="/assets/img/productos/laja/lajaOcre.jpg" alt="Image">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-4 col-md-5">
                    <div class="divider-btn">
                        <a class="btn-theme btn-white" href="product1.php">Contáctanos<i
